      ...
      <aside className={props.className}>
        <div className="">
          <Column className="bg-cyan_900 justify-end lg:p-[19px] xl:p-[24px] 2xl:p-[27px] 3xl:p-[32px] w-[100%]">
            ...
            <Row
              className="common-pointer items-start lg:ml-[41px] xl:ml-[52px] 2xl:ml-[58px] 3xl:ml-[70px] mr-[auto] lg:mt-[17px] xl:mt-[22px] 2xl:mt-[24px] 3xl:mt-[29px] w-[45%]"
            ...
            <Row className="items-start lg:ml-[38px] xl:ml-[48px] 2xl:ml-[54px] 3xl:ml-[64px] mr-[auto] lg:mt-[12px] xl:mt-[15px] 2xl:mt-[16px] 3xl:mt-[20px] w-[47%]">
              <Img
            ...
            <Row className="items-start justify-end lg:ml-[38px] xl:ml-[48px] 2xl:ml-[54px] 3xl:ml-[64px] lg:mt-[16px] xl:mt-[20px] 2xl:mt-[22px] 3xl:mt-[27px] w-[69%]">
              <Img
              ...
              />
              <Text
                className="font-poppins rowtodolistone"
                as="h5"
                variant="h5"
              >
                Service Updates
            ...
            <Button
              className="common-pointer flex lg:h-[31px] xl:h-[39px] 2xl:h-[43px] 3xl:h-[52px] items-center justify-center lg:ml-[36px] xl:ml-[46px] 2xl:ml-[51px] 3xl:ml-[62px] lg:mt-[129px] xl:mt-[162px] 2xl:mt-[182px] 3xl:mt-[218px] lg:w-[30px] xl:w-[38px] 2xl:w-[42px] 3xl:w-[51px]"
