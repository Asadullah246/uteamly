      ...
      <footer className={props.className}>
        <Column className="items-center justify-start w-[100%]">
          <Row className="bg-white_A700 items-start xl:p-[12px] 2xl:p-[13px] 3xl:p-[16px] lg:p-[9px] rounded-radius7 shadow-bs w-[100%]">
            ...
            <Text className="time7" variant="body2">
              12:00pm
            </Text>
            <Text className="time7" variant="body2">
              02:00pm
            </Text>
            <Text className="duration8" variant="body2">
              1 hours
            </Text>
            <Text className="Paid" variant="body2">
              Paid
            </Text>
          </Row>
          ...
          <Stack className="lg:h-[20px] xl:h-[25px] 2xl:h-[28px] 3xl:h-[33px] lg:mt-[16px] xl:mt-[20px] 2xl:mt-[22px] 3xl:mt-[27px] rounded-radius7 w-[100%]">
            ...
            <Row className="absolute bottom-[0] items-start left-[1%] w-[84%]">
              ...
              <Text
                className="mb-[1px] xl:ml-[104px] 2xl:ml-[117px] 3xl:ml-[140px] lg:ml-[83px] rowtime"
                variant="body2"
              >
                1 hours
              </Text>
              <Text
                className="font-nunito font-semibold mb-[1px] lg:ml-[125px] xl:ml-[157px] 2xl:ml-[176px] 3xl:ml-[212px] text-light_green_A701 w-[auto]"
                variant="body2"
              >
                Paid
              </Text>
