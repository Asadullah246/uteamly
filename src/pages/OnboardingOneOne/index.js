...
const OnboardingOneOnePage = () => {
  const navigate = useNavigate();

  function handleNavigate113() {
    navigate("/onboardingtwoone");
  }
  ...
  return (
    <>
      <Column className="bg-white_A700 font-poppins items-center justify-start mx-[auto] w-[100%]">
        <Row
          className="common-pointer items-start justify-between w-[100%]"
          onClick={handleNavigate113}
        >
          <Column className="justify-start w-[46%]">
            <Img
              src="images/img_whatsappimage_12.png"
...
export default OnboardingOneOnePage;
