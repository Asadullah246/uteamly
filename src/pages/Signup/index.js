      ...
      <Column className="bg-white_A700 font-poppins items-center justify-start mx-[auto] w-[100%]">
        <Row className="items-start justify-between w-[100%]">
          <Column className="justify-start w-[35%]">
            <Stack className="lg:h-[142px] xl:h-[178px] 2xl:h-[200px] 3xl:h-[240px] 3xl:mr-[109px] lg:mr-[64px] xl:mr-[81px] 2xl:mr-[91px] w-[82%]">
              <Text
                className="absolute bottom-[14%] left-[28%] text-black_900 w-[auto]"
                as="h1"
                variant="h1"
              >
                Signup
              ...
              <Img
                src="images/img_whatsappimage_20.png"
                className="absolute lg:h-[142px] xl:h-[178px] 2xl:h-[200px] 3xl:h-[240px] w-[100%]"
                alt="WhatsAppImage"
              />
            </Stack>
            <Column className="justify-start xl:ml-[101px] 2xl:ml-[113px] 3xl:ml-[136px] lg:ml-[80px] 2xl:mt-[10px] 3xl:mt-[12px] lg:mt-[7px] xl:mt-[9px] w-[77%]">
              <Column className="border-black_900_b2 border-bw05 border-solid items-center justify-start lg:p-[10px] xl:p-[13px] 2xl:p-[14px] 3xl:p-[17px] rounded-radius2646 w-[100%]">
                <Row
                  className="common-pointer items-end justify-center mb-[1px] w-[61%]"
              ...
              <Row className="items-start justify-between lg:mt-[23px] xl:mt-[29px] 2xl:mt-[32px] 3xl:mt-[39px] w-[100%]">
              ...
              <Input
                ...
                wrapClassName="2xl:mt-[28px] 3xl:mt-[33px] lg:mt-[20px] w-[100%] xl:mt-[25px]"
                type="text"
                name="GroupThree"
                placeholder="Name"
              ></Input>
              ...
              ></Input>
              <CheckBox
                className="font-normal 2xl:mt-[10px] 3xl:mt-[12px] lg:mt-[7px] xl:mt-[9px] not-italic xl:text-[12px] 2xl:text-[13px] 3xl:text-[16px] lg:text-[9px] text-black_900_9b"
              ...
              ></CheckBox>
              <Button
                className="common-pointer font-semibold lg:mt-[20px] xl:mt-[26px] 2xl:mt-[29px] 3xl:mt-[35px] lg:text-[12px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-center w-[100%]"
