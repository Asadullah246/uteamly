...
const DashboardPage = () => {
  ...
  function handleNavigate321() {
    navigate("/clockinone");
  }
  function handleNavigate322() {
    navigate("/bookingstask");
  }
  function handleNavigate325() {
        ...
        <Stack className="absolute lg:h-[576px] xl:h-[721px] 2xl:h-[811px] 3xl:h-[973px] left-[0] w-[95%]">
          <Column className="absolute items-center justify-start w-[100%]">
            <Row className="items-start w-[100%]">
              <Sidebar5
                className="w-[24%]"
                onrowtimetwentyoneClick={handleNavigate321}
                onrowgoogledocsoneClick={handleNavigate325}
              />
          ...
          >
            <Column className="justify-start lg:ml-[51px] xl:ml-[64px] 2xl:ml-[72px] 3xl:ml-[86px] lg:mt-[101px] xl:mt-[127px] 2xl:mt-[142px] 3xl:mt-[171px] w-[35%]">
