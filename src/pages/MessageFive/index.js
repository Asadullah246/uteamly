            ...
            <Stack className="absolute lg:h-[576px] xl:h-[721px] 2xl:h-[811px] 3xl:h-[973px] w-[100%]">
              <Column className="absolute items-center justify-start w-[100%]">
                <Row className="items-start justify-between w-[100%]">
                  <Sidebar3
                    className="w-[42%]"
                    onrowhelpdeskoneClick={handleNavigate101}
                    onrowgoogledocsoneClick={handleNavigate102}
                    onrowcareoneClick={handleNavigate103}
                    onrowgoogledocsoneoneClick={handleNavigate104}
                    onrowpartnershiponeClick={handleNavigate105}
                    onrowvideolessononeClick={handleNavigate110}
                  />
              ...
              <Column
                className="absolute bg-cover bg-repeat justify-end left-[0] p-[3px] top-[0] w-[53%]"
                style={{ backgroundImage: "url('images/img_group264.png')" }}
              >
                <Column className="justify-start lg:ml-[53px] xl:ml-[67px] 2xl:ml-[75px] 3xl:ml-[90px] lg:mt-[107px] xl:mt-[134px] 2xl:mt-[150px] 3xl:mt-[181px] w-[34%]">
...
export default MessageFivePage;
