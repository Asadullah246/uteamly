    ...
    <>
      <Stack className="bg-white_A700 font-poppins lg:h-[576px] xl:h-[721px] 2xl:h-[811px] 3xl:h-[973px] mx-[auto] lg:pr-[56px] xl:pr-[70px] 2xl:pr-[78px] 3xl:pr-[94px] w-[100%]">
        <Stack className="absolute lg:h-[576px] xl:h-[721px] 2xl:h-[811px] 3xl:h-[973px] left-[0] w-[95%]">
          ...
          <Row className="absolute items-start justify-center left-[28%] top-[40%] w-[19%]">
            <Text
            ...
            <Text
              className="xl:ml-[114px] 2xl:ml-[128px] 3xl:ml-[153px] lg:ml-[91px] columntutorials_one"
              as="h5"
              variant="h5"
            >
              Request
          ...
          >
            <Row className="items-center lg:ml-[26px] xl:ml-[33px] 2xl:ml-[37px] 3xl:ml-[44px] mr-[auto] xl:mt-[107px] 2xl:mt-[120px] 3xl:mt-[144px] lg:mt-[85px] w-[43%]">
              <Img
        ...
        <Row className="absolute items-center justify-center left-[6%] py-[2px] top-[26%] w-[8%]">
          <Img
        ...
        <Footer3 className="absolute bottom-[0] right-[0] w-[68%]" />
      </Stack>
    </>
  );
};

export default RequestTwoPage;
