        ...
        <Stack className="absolute lg:h-[576px] xl:h-[721px] 2xl:h-[811px] 3xl:h-[973px] left-[0] w-[95%]">
          <Column className="absolute items-center justify-start w-[100%]">
            <Row className="items-start w-[100%]">
              <Sidebar3
                className="w-[24%]"
                onrowemailfiftyoneClick={handleNavigate106}
                onrowgoogledocsoneClick={handleNavigate107}
                onrowcareoneClick={handleNavigate108}
                onrowpartnershiponeClick={handleNavigate109}
                onrowvideolessononeClick={handleNavigate114}
                onrowhelpdeskoneClick={handleNavigate115}
              />
          ...
          <Column
            ...
            style={{ backgroundImage: "url('images/img_group256.png')" }}
          >
