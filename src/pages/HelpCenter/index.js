            ...
            <Stack className="absolute lg:h-[576px] xl:h-[721px] 2xl:h-[811px] 3xl:h-[973px] w-[100%]">
              <Column className="absolute items-center justify-start left-[0] w-[76%]">
                <Row className="items-start justify-between w-[100%]">
                  <Sidebar6
                    className="w-[42%]"
                    onGroup3846Click={handleNavigate246}
                  />
              ...
              <Column
                className="absolute bg-cover bg-repeat justify-end left-[0] lg:p-[32px] xl:p-[41px] 2xl:p-[46px] 3xl:p-[55px] top-[0] w-[40%]"
                style={{ backgroundImage: "url('images/img_group120.png')" }}
              >
                <Row className="items-center lg:ml-[24px] xl:ml-[31px] 2xl:ml-[34px] 3xl:ml-[41px] mr-[auto] xl:mt-[102px] 2xl:mt-[114px] 3xl:mt-[137px] lg:mt-[81px] w-[44%]">
                  <Img
