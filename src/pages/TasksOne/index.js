      ...
      <Stack className="bg-white_A700 font-poppins lg:h-[576px] xl:h-[721px] 2xl:h-[811px] 3xl:h-[973px] mx-[auto] lg:pr-[56px] xl:pr-[70px] 2xl:pr-[78px] 3xl:pr-[94px] w-[100%]">
        <Stack className="absolute lg:h-[576px] xl:h-[721px] 2xl:h-[811px] 3xl:h-[973px] left-[0] w-[95%]">
          ...
          <Column
            ...
            style={{ backgroundImage: "url('images/img_group284.png')" }}
          >
            <Row
              className="common-pointer items-center lg:ml-[24px] xl:ml-[31px] 2xl:ml-[34px] 3xl:ml-[41px] mr-[auto] xl:mt-[103px] 2xl:mt-[115px] 3xl:mt-[139px] lg:mt-[82px] w-[43%]"
        ...
        <Row
          className="common-pointer absolute items-center justify-center left-[6%] py-[2px] top-[26%] w-[8%]"
