        ...
        <Row className="items-center w-[95%]">
          <Stack className="lg:h-[576px] xl:h-[721px] 2xl:h-[811px] 3xl:h-[973px] w-[57%]">
            <Stack className="absolute lg:h-[576px] xl:h-[721px] 2xl:h-[811px] 3xl:h-[973px] w-[100%]">
              <Column className="absolute items-center justify-start w-[100%]">
                <Row className="items-start justify-between w-[100%]">
                  <Sidebar6
                    className="w-[42%]"
                    onGroup3846Click={handleNavigate252}
                  />
              ...
              >
                <Row className="items-center lg:ml-[36px] xl:ml-[45px] 2xl:ml-[50px] 3xl:ml-[60px] mr-[auto] lg:mt-[104px] xl:mt-[130px] 2xl:mt-[146px] 3xl:mt-[175px] w-[39%]">
                  <Img
            ...
            <Row className="absolute bottom-[4%] items-start justify-between right-[3%] w-[87%]">
              <Row className="items-center justify-between lg:mt-[49px] xl:mt-[62px] 2xl:mt-[69px] 3xl:mt-[83px] py-[2px] w-[18%]">
                <Img
              ...
              <Column className="bg-white_A700 justify-end py-[1px] rounded-radius10 shadow-bs w-[56%]">
