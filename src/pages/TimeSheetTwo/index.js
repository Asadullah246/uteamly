...
const TimeSheetTwoPage = () => {
  const navigate = useNavigate();

  function handleNavigate125() {
    navigate("/timesheetpaidhourstwo");
  }
        ...
        <Stack className="absolute font-poppins lg:h-[576px] xl:h-[721px] 2xl:h-[811px] 3xl:h-[973px] left-[0] w-[95%]">
          <Column className="absolute items-center justify-start w-[100%]">
            <Row className="items-start w-[100%]">
              <Sidebar3
                className="w-[24%]"
                onrowhelpdeskoneClick={handleNavigate130}
                onrowemailfiftyoneClick={handleNavigate131}
                onrowcareoneClick={handleNavigate132}
                onrowgoogledocsoneoneClick={handleNavigate133}
                onrowpartnershiponeClick={handleNavigate134}
                onrowvideolessononeClick={handleNavigate139}
              />
          ...
          <Column
            ...
            style={{ backgroundImage: "url('images/img_group238.png')" }}
          >
...
export default TimeSheetTwoPage;
