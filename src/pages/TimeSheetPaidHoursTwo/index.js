...
const TimeSheetPaidHoursTwoPage = () => {
        ...
        <Stack className="absolute font-poppins lg:h-[576px] xl:h-[721px] 2xl:h-[811px] 3xl:h-[973px] left-[0] w-[95%]">
          <Column className="absolute items-center justify-start w-[100%]">
            <Row className="items-start w-[100%]">
              <Sidebar3
                className="w-[24%]"
                onrowpartnershiponeClick={handleNavigate111}
                onrowemailfiftyoneClick={handleNavigate116}
                onrowgoogledocsoneClick={handleNavigate117}
                onrowcareoneClick={handleNavigate118}
                onrowgoogledocsoneoneClick={handleNavigate119}
                onrowvideolessononeClick={handleNavigate123}
                onrowhelpdeskoneClick={handleNavigate124}
              />
          ...
          <Column
            ...
            style={{ backgroundImage: "url('images/img_group251.png')" }}
          >
...
export default TimeSheetPaidHoursTwoPage;
