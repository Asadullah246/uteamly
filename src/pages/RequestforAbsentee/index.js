      ...
      <Stack className="bg-white_A700 font-poppins lg:h-[576px] xl:h-[721px] 2xl:h-[811px] 3xl:h-[973px] mx-[auto] w-[100%]">
        <Stack className="absolute lg:h-[576px] xl:h-[721px] 2xl:h-[811px] 3xl:h-[973px] left-[0] w-[95%]">
          ...
          <Column
            ...
            style={{ backgroundImage: "url('images/img_group295.png')" }}
          >
        ...
        <Column className="absolute bg-black_900_7f font-poppins items-center justify-start lg:p-[52px] xl:p-[65px] 2xl:p-[73px] 3xl:p-[87px] w-[100%]">
          <Column className="items-center justify-start lg:mb-[22px] xl:mb-[28px] 2xl:mb-[31px] 3xl:mb-[37px] w-[48%]">
            <Column className="bg-white_A700 items-center justify-start lg:p-[29px] xl:p-[37px] 2xl:p-[41px] 3xl:p-[49px] rounded-radius15 w-[100%]">
              <Text
                className="font-semibold text-blue_600 w-[auto]"
                as="h4"
                variant="h4"
              ...
              <Column className="items-center justify-start lg:mb-[13px] xl:mb-[17px] 2xl:mb-[19px] 3xl:mb-[22px] lg:mt-[24px] xl:mt-[31px] 2xl:mt-[34px] 3xl:mt-[41px] w-[71%]">
                <Input
                ...
                <Input
                  ...
                  placeholder="Date"
                ></Input>
                <Column className="border-black_900_b2 border-bw05 border-solid justify-start lg:mt-[14px] xl:mt-[18px] 2xl:mt-[20px] 3xl:mt-[24px] lg:p-[16px] xl:p-[21px] 2xl:p-[23px] 3xl:p-[28px] rounded-radius7 w-[100%]">
...
export default RequestforAbsenteePage;
