      ...
      <Column className="bg-white_A700 font-poppins justify-start mx-[auto] w-[100%]">
        <Row className="items-center w-[95%]">
          <Stack className="lg:h-[576px] xl:h-[721px] 2xl:h-[811px] 3xl:h-[973px] w-[57%]">
            <Stack className="absolute lg:h-[576px] xl:h-[721px] 2xl:h-[811px] 3xl:h-[973px] w-[100%]">
              <Column className="absolute items-center justify-start w-[100%]">
                <Row className="items-start justify-between w-[100%]">
                  <Sidebar8
                    className="w-[42%]"
                    onGroup3846Click={handleNavigate168}
                  />
              ...
              <Column
                className="absolute bg-cover bg-repeat justify-end left-[0] lg:p-[21px] xl:p-[27px] 2xl:p-[30px] 3xl:p-[36px] top-[0] w-[53%]"
                style={{ backgroundImage: "url('images/img_group210.png')" }}
              >
                <Row
                  className="common-pointer items-center lg:ml-[34px] xl:ml-[43px] 2xl:ml-[48px] 3xl:ml-[58px] mr-[auto] lg:mt-[104px] xl:mt-[130px] 2xl:mt-[146px] 3xl:mt-[175px] w-[39%]"
            ...
            <Row className="absolute bottom-[4%] items-start justify-between right-[3%] w-[87%]">
              <Row
                className="common-pointer items-center justify-between lg:mt-[49px] xl:mt-[62px] 2xl:mt-[69px] 3xl:mt-[83px] py-[2px] w-[18%]"
              ...
              <Column className="bg-white_A700 justify-end py-[1px] rounded-radius10 shadow-bs w-[55%]">
...
export default MessageFourPage;
