      ...
      <Stack className="bg-white_A700 font-poppins lg:h-[576px] xl:h-[721px] 2xl:h-[811px] 3xl:h-[973px] mx-[auto] w-[100%]">
        ...
        <Column className="absolute justify-start left-[26%] top-[30%] w-[18%]">
          <Column className="bg-cyan_900 items-center justify-start lg:p-[10px] xl:p-[13px] 2xl:p-[14px] 3xl:p-[17px] rounded-radius4 w-[75%]">
            <Text className="mb-[1px] text-white_A700 w-[auto]" variant="body4">
              Add New Task
            </Text>
          </Column>
        ...
        <Img
          src="images/img_whatsappimage_15.png"
          className="WhatsAppImage4"
          alt="WhatsAppImage"
        />
        <Column className="absolute bg-black_900_68 bottom-[0] font-poppins justify-start lg:p-[41px] xl:p-[52px] 2xl:p-[58px] 3xl:p-[70px] w-[100%]">
          <Column className="items-center justify-start xl:mb-[10px] 2xl:mb-[11px] 3xl:mb-[13px] lg:mb-[8px] lg:ml-[14px] xl:ml-[18px] 2xl:ml-[20px] 3xl:ml-[24px] w-[72%]">
            <Row className="items-start justify-between w-[100%]">
              <Column className="justify-start 3xl:mt-[116px] lg:mt-[68px] xl:mt-[86px] 2xl:mt-[96px] w-[15%]">
                ...
                <Row
                  className="common-pointer items-start lg:mt-[17px] xl:mt-[22px] 2xl:mt-[24px] 3xl:mt-[29px] w-[86%]"
                ...
                <Row className="items-center lg:mt-[16px] xl:mt-[20px] 2xl:mt-[22px] 3xl:mt-[27px] w-[79%]">
                  <Img
                ...
                <Row className="items-start lg:mt-[17px] xl:mt-[22px] 2xl:mt-[24px] 3xl:mt-[29px] w-[96%]">
                  <Img
                ...
                <Row
                  className="common-pointer items-start lg:mt-[16px] xl:mt-[20px] 2xl:mt-[22px] 3xl:mt-[27px] w-[77%]"
                ...
                <Row
                  className="common-pointer items-center lg:mt-[16px] xl:mt-[20px] 2xl:mt-[22px] 3xl:mt-[27px] w-[100%]"
