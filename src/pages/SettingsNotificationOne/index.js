...
const SettingsNotificationOnePage = () => {
  const navigate = useNavigate();

  function handleNavigate185() {
    navigate("/settingsprivacypoliciesone");
  }
      ...
      <Stack className="bg-white_A700 font-poppins lg:h-[576px] xl:h-[721px] 2xl:h-[811px] 3xl:h-[973px] mx-[auto] lg:pr-[56px] xl:pr-[70px] 2xl:pr-[78px] 3xl:pr-[94px] w-[100%]">
        <Stack className="absolute lg:h-[576px] xl:h-[721px] 2xl:h-[811px] 3xl:h-[973px] left-[0] w-[95%]">
          ...
          <Column
            ...
            style={{ backgroundImage: "url('images/img_group188.png')" }}
          >
        ...
        <Row className="absolute inset-x-[0] items-start justify-center mx-[auto] top-[25%] w-[44%]">
          ...
          <Text
            className="font-medium lg:ml-[53px] xl:ml-[67px] 2xl:ml-[75px] 3xl:ml-[90px] text-black_900_6d w-[auto]"
            as="h5"
            variant="h5"
          >
            Terms & Conditions
...
export default SettingsNotificationOnePage;
