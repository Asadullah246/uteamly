    ...
    <>
      <Stack className="bg-white_A700 font-poppins lg:h-[576px] xl:h-[721px] 2xl:h-[811px] 3xl:h-[973px] mx-[auto] lg:pr-[56px] xl:pr-[70px] 2xl:pr-[78px] 3xl:pr-[94px] w-[100%]">
        ...
        <Column
          ...
          style={{ backgroundImage: "url('images/img_group136.png')" }}
        >
          <Column className="justify-start lg:ml-[53px] xl:ml-[67px] 2xl:ml-[75px] 3xl:ml-[90px] lg:mt-[106px] xl:mt-[133px] 2xl:mt-[149px] 3xl:mt-[179px] w-[34%]">
            <Row
...
export default BookingstaskOnePage;
