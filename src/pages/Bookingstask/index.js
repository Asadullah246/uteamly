...
const BookingstaskPage = () => {
  const navigate = useNavigate();

  function handleNavigate326() {
    navigate("/");
  }
  function handleNavigate333() {
    navigate("/clockinone");
  }
      ...
      <Stack className="bg-white_A700 font-poppins lg:h-[576px] xl:h-[721px] 2xl:h-[811px] 3xl:h-[973px] mx-[auto] lg:pr-[56px] xl:pr-[70px] 2xl:pr-[78px] 3xl:pr-[94px] w-[100%]">
        <Column className="absolute items-center justify-start left-[0] w-[95%]">
          <Row className="items-start w-[100%]">
            <Sidebar5
              className="w-[24%]"
              onrowtimetwentyoneClick={handleNavigate333}
            />
        ...
        <Button
          className="absolute font-medium left-[26%] xl:text-[11px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[8px] text-center top-[30%] w-[13%]"
        ...
        <Column
          className="absolute bg-cover bg-repeat font-poppins justify-end left-[0] 3xl:p-[10px] lg:p-[6px] xl:p-[8px] 2xl:p-[9px] top-[0] w-[28%]"
          style={{ backgroundImage: "url('images/img_group9.png')" }}
        >
          <Column className="justify-start lg:ml-[48px] xl:ml-[61px] 2xl:ml-[68px] 3xl:ml-[82px] lg:mt-[100px] xl:mt-[125px] 2xl:mt-[140px] 3xl:mt-[168px] w-[36%]">
            <Row
              className="common-pointer items-center ml-[2px] w-[98%]"
              onClick={handleNavigate326}
            >
              <Img
...
export default BookingstaskPage;
